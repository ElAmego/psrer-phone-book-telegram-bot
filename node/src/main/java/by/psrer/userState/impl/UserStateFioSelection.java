...
@Service
public final class UserStateFioSelection implements UserStateHandler {
    private final EmployeeDAO employeeDAO;
    private final MessageUtils messageUtils;

    public UserStateFioSelection(final EmployeeDAO employeeDAO, final MessageUtils messageUtils) {
